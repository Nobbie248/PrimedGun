...
void ToolBar::MakeActions()
{
  ...
  for (const auto& action :
       {m_pause_play_action, m_stop_action, m_config_action, m_controllers_action, m_step_action,
        m_step_over_action, m_step_out_action, m_skip_action, m_show_pc_action, m_set_pc_action})
  {
