...
constexpr std::array<const char*, NUM_HOTKEYS> s_hotkey_labels{{
    ...
    _trans("Toggle OpenXR"),
    _trans("Reset VR Position"),
    _trans("Decrease Units Per Meter"),
    ...
    _trans("Decrease Screen Size"),
    _trans("Increase Screen Size"),
    _trans("Decrease Screen Curvature"),
    _trans("Increase Screen Curvature"),
    ...
    _trans("Cycle Shader Type"),
    _trans("Cycle Override Handling"),
    _trans("Previous Shader"),
    _trans("Next Shader"),
