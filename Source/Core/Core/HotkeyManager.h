...
enum Hotkey
{
  ...
  HK_VR_TOGGLE_OPENXR,
  HK_VR_RESET_POSITION,
  HK_VR_DECREASE_UNITS_PER_METER,
  HK_VR_INCREASE_UNITS_PER_METER,
  HK_VR_DECREASE_LEAN_BACK_ANGLE,
  HK_VR_INCREASE_LEAN_BACK_ANGLE,
  HK_VR_TOGGLE_ENABLE_CAMERA_FORWARD,
  HK_VR_DECREASE_CAMERA_FORWARD,
  HK_VR_INCREASE_CAMERA_FORWARD,
  HK_VR_TOGGLE_ENABLE_CAMERA_HEIGHT,
  HK_VR_DECREASE_CAMERA_HEIGHT,
  HK_VR_INCREASE_CAMERA_HEIGHT,
  HK_VR_TOGGLE_VIRTUAL_SCREEN,
  HK_VR_DECREASE_SCREEN_DISTANCE,
  HK_VR_INCREASE_SCREEN_DISTANCE,
  HK_VR_DECREASE_SCREEN_SIZE,
  HK_VR_INCREASE_SCREEN_SIZE,
  HK_VR_DECREASE_SCREEN_CURVATURE,
  HK_VR_INCREASE_SCREEN_CURVATURE,
  HK_VR_TOGGLE_DONT_CLEAR_SCREEN,
  HK_VR_TOGGLE_FORCE_VBI,
  HK_VR_TOGGLE_REMOVE_CINEMATIC_BARS,

  HK_VR_SHADER_TOGGLE_HUNTING,
  HK_VR_SHADER_CYCLE_HUNTING_OPTION,
  HK_VR_SHADER_CYCLE_TYPE,
  HK_VR_SHADER_CYCLE_HANDLING,
  HK_VR_SHADER_PREV,
  HK_VR_SHADER_NEXT,
  HK_VR_SHADER_PREV_TEXTURE_HASH,
  HK_VR_SHADER_NEXT_TEXTURE_HASH,
  HK_VR_SHADER_TOGGLE_TEXTURE_HASH,
  HK_VR_SHADER_SAVE_OVERRIDE,
