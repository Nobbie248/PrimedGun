...
{
  if (constants.vr_layer_override != m_vr_texture_layer_override)
  {
    constants.vr_layer_override = m_vr_texture_layer_override;
    constants.vr_layer_override_pad = 0;
    dirty = true;
  }
...
void PixelShaderManager::SetVRTextureLayerOverride(int layer)
{
  m_vr_texture_layer_override = layer;
}
