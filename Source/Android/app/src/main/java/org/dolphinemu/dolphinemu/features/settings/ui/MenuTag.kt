...
enum class MenuTag {
    ...
    OPENXR("openxr"),
    QUEST_VR_CAMERA("quest_vr_camera"),
    QUEST_VR_VIRTUAL_SCREEN("quest_vr_virtual_screen"),
    QUEST_VR_RENDERING("quest_vr_rendering"),
    QUEST_VR_FRAMERATE("quest_vr_framerate"),
    QUEST_VR_HACKS("quest_vr_hacks"),
    QUEST_VR_PASSTHROUGH("quest_vr_passthrough"),
    QUEST_VR_DEBUG("quest_vr_debug"),
    HACKS("hacks"),
